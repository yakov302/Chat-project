...
typedef enum Message_type
{
    ...
    PRINT_EXISTING_USERS_REQUEST,
    JOIN_EXISTING_GROUP_REQUEST,
    OPEN_PRIVATE_CHAT_REQUEST,
    LEAVE_GROUP_REQUEST,
    ...
    PRINT_EXISTING_USERS_SUCCESS,
    PRINT_EXISTING_USERS_NO_USERS,
    ...
    OPEN_PRIVATE_CHAT_SUCCESS,
    OPEN_PRIVATE_CHAT_FAIL,
    OPEN_PRIVATE_CHAT_PRIVATE_CHAT_ALREADY_EXISTS,
    OPEN_PRIVATE_CHAT_USER_NOT_EXISTS,
